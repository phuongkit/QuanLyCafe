...
namespace QuanLyCafe
{
    public partial class FrmManHinhChinhNhanVien : Form
    {
        ...
        public FrmManHinhChinhNhanVien(MyForm.FrmLogin frmLG, string IDNhanVien, string connectionString)
        {
            this.frmLG = frmLG;
        ...
        private void FrmManHinhChinhNhanVien_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (thoat)
            {
        ...
        {
            MyForm.FrmSuDungDichVu frmSDDV = new MyForm.FrmSuDungDichVu(this, IDNhanVien, connectionString);
            ShowForm(frmSDDV, btnSuDungDichVu);
        }

        private void btnNhapHang_Click(object sender, EventArgs e)
        {
            MyForm.FrmSuDungNhapHang frmNH = new MyForm.FrmSuDungNhapHang(this, IDNhanVien, connectionString);
            ShowForm(frmNH, btnNhapHang);
        }
